...
var aboutCloseButton = document.createElement('button');
...
var boxes = Array.from(document.querySelectorAll('.footer__container')); // считываем все элементы аккордеона в массив
...
function boxHandler(e) {
  ...
  var currentBox = e.target.closest('.footer__container'); // определяем текущий бокс
  var currentContent = e.target.nextElementSibling; // находим скрытый контент
...
// smooth scroll
var smoothLink = document.querySelector('.base__button');
...
var modalInpPhone = document.querySelector('.modal__label-phone');
var formInpPhone = document.querySelector('.form__label-phone');
Object(_modules_form_validate_init_phone_input__WEBPACK_IMPORTED_MODULE_3__["initPhoneInput"])(modalInpPhone);
Object(_modules_form_validate_init_phone_input__WEBPACK_IMPORTED_MODULE_3__["initPhoneInput"])(formInpPhone);
// Проверяем фокус
